    ...
    return Container(
      ...
      child: Card(
        child: ExpansionTile(
          ...
          title: Text(category.data["title"], style: TextStyle(color: Colors.grey[850], fontWeight: FontWeight.w500)),
          children: <Widget>[
            FutureBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                return Column(
                  children: snapshot.data == null ? [] : snapshot.data.documents.map<Widget>((doc){
                    return ListTile(
                      leading: CircleAvatar(
                        backgroundColor: Colors.transparent,
